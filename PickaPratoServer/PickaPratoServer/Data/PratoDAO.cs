...
namespace PickaPratoServer.Data
{
    public class PratoDAO
    {
        ...
        public List<Prato> GetPratos(string rest)
        {
            ...
            ";
            command.Parameters.Add(new SqlParameter("@restaurante", rest));
            var result = command.ExecuteReader();
            Prato p;
            Restaurante r = new Restaurante();
            while (result.Read())
        ...
        public bool verificaComentario(Classificacao c)
        {
            connection.Open();
            ...
            command.CommandText = @"
                ...
                WHERE prato = @prato AND cliente = @cli
            ";
            command.Parameters.Add(new SqlParameter("@cli", c.Utilizador));
            command.Parameters.Add(new SqlParameter("@prato", c.idPrato));
            ;
        ...
        public void AtualizaClassificacao(Classificacao c)
        {
            connection.Open();
